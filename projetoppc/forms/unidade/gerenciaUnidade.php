...
<body>
	...
	?>
	<h2>Alterando os dados da unidade selecionada</h2><br>
	<?php
	...
	<form action="" method="post">
			<div class="form-group">
				<label for="uninome">Nome da unidade SENAC: </label> <input
					type="text" name="uninome" id="uninome" class="form-control" value="<?=$unidade["uninome"]; ?>">
			</div>
			<br>
			<div class="form-group">
				<input type="submit" value="salvar" class="btn btn-success">
		...
		?>
		<h2>Excluindo a unidade SENAC</h2><br>
		<?php
		$unidade = buscarUnidadePorId($_GET["unicod"]);
		?>
		<form action="" method="post">
